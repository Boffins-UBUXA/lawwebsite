            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
              {notaryServices.map((service, index) => (
                <motion.div
                  ...
                  className="flex"
                >
                  <Card className="p-6 flex flex-col justify-between h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-border">
                    <div>
                    ...
                    <ul className="space-y-2 mt-auto">
                      {service.features.map((feature, featureIndex) => (
                        <li
                          key={featureIndex}
                          className="flex items-center text-sm text-muted-foreground leading-snug"
                        >
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <a href="tel:+12898382982" className="text-foreground hover:underline">
                      +1 (289) 838-2982
                    </a>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Mail className="h-5 w-5 text-primary" />
                    <a href="mailto:info@bekwynlaw.com" className="text-foreground hover:underline">
                      info@bekwynlaw.com
                    </a>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-foreground">
                      Bekwyn Law Head Office, Ontario, Canada
                    </span>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <Card className="p-8 border-border h-full flex flex-col justify-between">
                  ...
                  <form className="space-y-4">
                    ...
                    <Button className="w-full hover:scale-[1.02] transition">
