        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="text-white">
            ...
            <motion.h1
              ...
              className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-6 text-balance leading-tight"
            >
              Trusted Ontario Lawyers Protecting What Matters Most to You.
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-lg md:text-xl mb-8 text-white/90 text-pretty leading-relaxed"
            >
              At Bekwyn Law, we believe that law is about people, not just paperwork. We proudly serve
              individuals, families, and businesses with practical, compassionate, and results-driven legal support
              across Immigration, Family Law, Litigation, Employment Law and Estate Planning.
            </motion.p>
            <motion.p
              initial={{ y: 30, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
          ...
          {/* Right Image - Hidden on mobile since it's now background */}
          <motion.div
          ...
          >
            <div className="relative">
              <motion.div
                ...
                className="absolute -top-4 -right-4 w-20 h-20 bg-secondary/20 rounded-full"
              />
              <motion.div
                animate={{
                  scale: [1.2, 1, 1.2],
